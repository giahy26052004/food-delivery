    ...
    <div className="w-full pb-10">
      <div className="md:w-[70%] w-full m-auto">
        <form onSubmit={handleSubmit(onSubmit)} className="mt-5">
          <div>
            <label className="text-black">Enter Food Name</label>
            <input
              {...register("name")}
              type="text"
          ...
          <div>
            <label className="mt-2">Enter Food Description</label>
            <textarea
          ...
          <div className="flex items-center flex-wrap justify-between">
            ...
            <div className="w-[48%]">
              <label className="text-black mt-2">Enter Phone</label>
              <input
                {...register("phone", {
                  valueAsNumber: false,
                })}
            ...
            <div className="w-[48%]">
              <label className="text-black mt-2">Enter address</label>
              <input
                {...register("address")}
                type="text"
                placeholder="25"
          ...
          <div>
            ...
            <div className="w-full">
              ...
              <label
                htmlFor="file"
                className={`w-full mt-2 rounded-md min-h-[15vh] border-black p-3 border flex items-center justify-center ${
